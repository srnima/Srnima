...
<!-- 
**srnima/Srnima** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
With deep experience in repairing mobile phones, laptops, and desktop systems, my work includes installing custom operating systems (AndroidOS, LineageOS, Linux), optimizing CPU and fan performance, and documenting full boot and repair processes. But beyond technical skills, my mission is to make technology understandable, accessible, and inspiring — for children, beginners, and professional engineers alike, in every country.
